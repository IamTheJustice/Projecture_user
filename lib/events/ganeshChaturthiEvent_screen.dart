...
class GaneshChturthiScreen extends StatefulWidget {
  const GaneshChturthiScreen({Key? key}) : super(key: key);

  @override
  State<GaneshChturthiScreen> createState() => _GaneshChturthiScreenState();
}

class _GaneshChturthiScreenState extends State<GaneshChturthiScreen> {
  List<Map<String, dynamic>> detailList = <Map<String, dynamic>>[
    {"imagepath": 'assets/images/g1.jpeg'},
    {"imagepath": 'assets/images/g2.jpeg'},
    {"imagepath": 'assets/images/g3.jpeg'},
    {"imagepath": 'assets/images/g4.jpeg'},
    {"imagepath": 'assets/images/g5.jpeg'},
    {"imagepath": 'assets/images/g6.jpeg'},
          ...
          Stack(
            children: [
              Container(
                ...
                child: Image.asset("assets/images/g.jpeg", fit: BoxFit.fill),
              ),
              Padding(
