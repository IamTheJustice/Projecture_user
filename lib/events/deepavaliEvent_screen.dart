...
class DeepavaliScreen extends StatefulWidget {
  const DeepavaliScreen({Key? key}) : super(key: key);

  @override
  State<DeepavaliScreen> createState() => _DeepavaliScreenState();
}

class _DeepavaliScreenState extends State<DeepavaliScreen> {
  List<Map<String, dynamic>> detailList = <Map<String, dynamic>>[
    ...
    {"imagepath": 'assets/images/d4.jpeg'},
    {"imagepath": 'assets/images/d5.jpeg'},
    {"imagepath": 'assets/images/d6.jpeg'},
    {"imagepath": 'assets/images/d.jpeg'},
  ];
  @override
          ...
          Stack(
            children: [
              Container(
                ...
                child: Image.asset("assets/images/d1.jpeg", fit: BoxFit.fill),
              ),
              Padding(
